...
<div class="container">
    ...
    <form action="/products/index" enctype="multipart/form-data" method="GET" role="search">
        @csrf
        ...
        @foreach (json_decode($products)->data as $product)
            @if ($product->available == true) 
                <li> 
                    ...
                    <a href="/products/{{$product->id}}">Show Product</a> <br>
                    <a href="/products/{{$product->id}}/edit">Edit Product</a> <br> 
                    <br> <br>
